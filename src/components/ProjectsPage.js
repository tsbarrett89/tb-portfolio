    ...
    return (
        <ProjectsContainer id="projects">
            ...
            <ProjectContainer>
                ...
                <ProjectDescription>Created this simple site to help my D&D players to quickly create a daily spell list. One can search the basic spells and choose them to add to the Spell Sheet. The D&D 5e API is used until I can create a back-end that will contain all spells. Tech stack - React with Redux, Styled Components</ProjectDescription>
            </ProjectContainer>
        </ProjectsContainer>
    )
}
